  ...
  return (
    ...
    >
      <div className="container mx-auto flex flex-col md:flex-row items-start md:items-center justify-between gap-8 md:gap-20">
        ...
        >
          <img src="/playtomic-cover-image.webp" alt="Playtomic Cover" className="w-full h-[400px] aspect-square rounded-2xl object-cover" />
        </motion.div>
        {/* Right: Logo and text */}
        <motion.div
          ...
          variants={itemVariants}
        >
          <img src="/playtomic-logo.svg" alt="Playtomic Logo" className="h-8 mb-4 mx-0" />
...
export default PlaytomicSection